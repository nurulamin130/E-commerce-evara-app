...
class ProductImage extends Model
{
    ...
    private static function getImageUrl($images)
    {

        self::$extension    = $images->getClientOriginalExtension();
        self::$imageName    = rand(0, 500000).'.'.self::$extension; // 256555.jpg
        self::$directory    = 'upload/productotherimages/';
        $images->move(self::$directory, self::$imageName);
